<template>
  <div style="backgroundColor: #ff2323" class="w-full h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <h1 class="text-5xl md:text-6xl absolute top-0 text-white font-bold mt-8 tracking-wide">POPTOPIK</h1>
    <h1 class="text-5xl md:text-6xl absolute top-0 text-white font-bold mt-20 pt-2 md:pt-0 md:mt-24 tracking-wide">{{ pops }}</h1>
...
<script>
  import taufik1 from './assets/images/taufik1.png'
  import taufik2 from './assets/images/taufik2.png'
